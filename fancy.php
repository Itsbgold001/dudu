...
<style type="text/css">
form#photo_form{background:#F3FDD0; border:#AFD80E 1px solid; padding:20px; width: 903px;}
div#galleries{
	padding: 10px;}
div#galleries > div{float:left; margin:10px; text-align:center; cursor:pointer;
}
div#galleries > div > div {height:200px; overflow:hidden;}
div#galleries > div > div > img{width:200px; cursor:pointer; height:200px; border: groove;}
div#photos{display:none; border:#666 1px solid; padding:20px; height: auto; width: 900px;}
div#photos > div{float:left; width:150px; height:80px; overflow:hidden; margin:10px; height: 150px;}
div#photos > div > img{width:150px; height: 150px; cursor:pointer; border: ridge thin;}
div#picbox{display:none; padding-top:36px;}
div#picbox > img{max-width:600px; max-height:500px; display:block; margin:0px auto; border:ridge thick; }
div#picbox > button{ display:block; float:right; font-size:36px; padding:px 1px; height: 40px; width: 40px; text-align: center;}
...
function showGallery(gallery,user){
	...
	_("section_title").innerHTML = '<a href="user.php?u=<?php echo $u; ?>"><?php echo $u; ?></a>s '+gallery+' Gallery &nbsp; <button onclick="backToGalleries()">Go back to all galleries</button>';
...
<?php include_once("duduInteractive.php"); ?>
  ...
  <h2 id="section_title"><a href="user.php?u=<?php echo $u; ?>"><?php echo $u; ?></a>&#39;s Photo Galleries</h2>
