...
if (isset($_POST['action']) && $_POST['action'] == "status_post"){
	...
	//STILL HAVING TROUBLE WITH THIS BIT OF CODE
	...
	$sql = "SELECT COUNT(id) FROM users WHERE username='$account_name' OR username='$log_username' AND activated='1' LIMIT 1";
	...
	//Commented this out for now because i dont want to notify everyone associated with user1 or user2
	$friends = array();
