...
if($_POST)
{
	...
	{			
		...
		case 'up': 
			...
			//check if user has already voted, determined by unique content cookie but i'm still having problems with this gonna have to look for a way to prevent double voting :)
