...
if($isFriend == true && $isOwner == "no"){
	$pm_ui = "<hr>";
	$pm_ui .= '<input id="pmsubject" onkeyup="statusMax(this,30)" placeholder="Subject..."><br />';
	$pm_ui .= '<br /><textarea id="pmtext" onkeyup="statusMax(this,250)" placeholder="Send '.$u.' a private message"></textarea>';
	$pm_ui .= '<button id="pmBtn" onclick="postPm(\''.$u.'\',\''.$log_username.'\',\'pmsubject\',\'pmtext\')" >Send</button><a  href="javascript:void(0);" class="" onClick="vpb_hide_popup_boxes();">Cancel</a>';
}
?>
<script>
